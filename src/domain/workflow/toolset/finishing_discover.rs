...
/// Finishing toolset for Discover/Plan mode - update_todo only
pub struct FinishingDiscoverToolset {
    tools: HashMap<String, Box<dyn Tool>>,
}

impl FinishingDiscoverToolset {
...
impl Toolset for FinishingDiscoverToolset {
